      ...
      <div className="mx-auto grid w-full max-w-5xl grid-cols-1 items-center gap-16 lg:grid-cols-7">
        <div className="space-y-6 lg:col-span-4">
          ...
          <p className="text-lg text-grey-900/80">
            ...
            <span className="font-bold">50% off MSRP</span> year one,{" "}
            <span className="font-bold">30% off</span> year two, and{" "}
            <span className="font-bold">20% off</span> year three as part of a
            three-year contract.
          </p>
          <LPImage
